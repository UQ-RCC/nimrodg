...
public class AMQProcessor implements AutoCloseable {
	...
	private class _Consumer extends DefaultConsumer {
		...
		public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
			AMQProcessor.this.handleDelivery(consumerTag, envelope, properties, body);
		}
	}
	...
	private class _ConfirmListener implements ConfirmListener {
		...
		public void handleAck(long deliveryTag, boolean multiple) throws IOException {
			AMQProcessor.this.handleAck(deliveryTag, multiple);
		}

		@Override
		public void handleNack(long deliveryTag, boolean multiple) throws IOException {
			AMQProcessor.this.handleNack(deliveryTag, multiple);
		}
	}
