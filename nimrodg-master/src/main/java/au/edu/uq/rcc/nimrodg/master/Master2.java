...
public class Master2 implements MessageQueueListener, AutoCloseable {

	private static final Logger LOGGER = LogManager.getLogger(Master2.class);
	...
	public Master2(NimrodMasterAPI nimrod, Experiment experiment, JobSchedulerFactory jsf, AgentSchedulerFactory asf) {
